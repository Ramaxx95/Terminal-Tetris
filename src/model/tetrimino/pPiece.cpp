...
int PPiece::rotate(){
    ...
    if(this->curr_shape == 1){
        this->blocks[0].changePosition(this->x, this->y + 2);
        this->blocks[1].changePosition(this->x + 1, this->y + 2);
        ...
        this->blocks[1].changePosition(this->x + 2, this->y);
        ...
        this->blocks[1].changePosition(this->x, this->y);
