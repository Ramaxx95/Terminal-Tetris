...
int LPiece::rotate(){
    ...
    if(this->curr_shape == 1){
        ...
        this->blocks[2].changePosition(this->x, this->y + 2);
        this->blocks[3].changePosition(this->x + 1, this->y + 2);
        ...
        this->blocks[2].changePosition(this->x + 2, this->y + 1);
        ...
        this->blocks[2].changePosition(this->x, this->y);
        this->blocks[3].changePosition(this->x, this->y + 1);
