...
TPiece::TPiece(int pos_x, int pos_y) : Tetrimino(pos_x, pos_y, 3, 2, 1, 1, 4) {
    ...
    this->blocks.emplace_back(Block(pos_x + 2, pos_y + 1));
    ...
    this->blocks[1].addBlock(RIGHT_SIDE, &this->blocks[3]);
...
int TPiece::rotate(){
    ...
    if(this->curr_shape == 1){
        ...
        this->blocks[3].changePosition(this->x + 2, this->y + 1);
        ...
        this->blocks[3].changePosition(this->x + 1, this->y);
        ...
        this->blocks[1].addBlock(UPPER_SIDE, &this->blocks[3]);
        this->blocks[2].addBlock(RIGHT_SIDE, &this->blocks[1]);
        this->blocks[3].addBlock(LOWER_SIDE, &this->blocks[1]);
    }
    else if (this->curr_shape == 3){
        this->blocks[0].changePosition(this->x + 2, this->y);
        this->blocks[1].changePosition(this->x + 1, this->y);
        this->blocks[2].changePosition(this->x + 1, this->y + 1);
        this->blocks[3].changePosition(this->x, this->y);

        this->blocks[0].addBlock(LEFT_SIDE, &this->blocks[1]);
        this->blocks[1].addBlock(RIGHT_SIDE, &this->blocks[0]);
        this->blocks[1].addBlock(LOWER_SIDE, &this->blocks[2]);
        this->blocks[1].addBlock(LEFT_SIDE, &this->blocks[3]);
        ...
        this->blocks[1].changePosition(this->x, this->y + 1);
        this->blocks[2].changePosition(this->x + 1, this->y + 1);
        this->blocks[3].changePosition(this->x, this->y + 2);

        this->blocks[0].addBlock(LOWER_SIDE, &this->blocks[1]);
        this->blocks[1].addBlock(UPPER_SIDE, &this->blocks[0]);
        this->blocks[1].addBlock(RIGHT_SIDE, &this->blocks[2]);
        this->blocks[1].addBlock(LOWER_SIDE, &this->blocks[3]);
