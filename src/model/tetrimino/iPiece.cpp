...
IPiece::IPiece(int pos_x, int pos_y) : Tetrimino(pos_x, pos_y, 1, 4, 1, 1, 2) {
    ...
    this->blocks.emplace_back(Block(pos_x + 1, pos_y + 3));
...
int IPiece::rotate(){
    ...
    if(this->curr_shape == 1){
        ...
        this->blocks[2].changePosition(this->x + 1, this->y + 2);
        this->blocks[3].changePosition(this->x + 1, this->y + 3);
        ...
        this->blocks[3].changePosition(this->x + 3, this->y + 1);
